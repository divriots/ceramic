      ...
      <div
        ...
        <ul>
          <li class="mb-4 flex items-start text-left" v-for="feature of features">
            ...
            <p class="ml-3 text-base font-medium text-gray-500" v-html="feature.description"></p>
          </li>
        </ul>
        ...
        <div class="mt-8">
          ...
          <div class="flex items-center justify-center rounded-lg shadow-md bg-background hover:shadow-xl">
            <a :href="action.url"
