    ...
    <div class="highlights-wrapper">
      ...
      <div class="highlights-container">
          ...
          <component :is="Card" url="/starterkits" style="background-color: #212121">
            <div class="w-full h-full text-2xl sm:text-3xl"
              ...
              <div class="flex flex-wrap">
                <div class="flex my-2">
                  <!--Sass-->
                  <svg width="35" height="35" class="mr-2 fill-current" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <!--Angular-->
                  <svg width="35" height="35" class="mr-2 fill-current" viewBox="0 0 128 128">
                    <path
                  ...
                  <!--Vue-->
                  <svg width="35" height="35" class="mr-2 " version="1.1" viewBox="0 0 261.76 226.69"
                ...
                <div class="flex">
                  <!--Chakra-->
                  <svg width="35" height="35" class="mr-2 " viewBox="0 0 100 100" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <!--system-ui-->
                  <svg width="35" height="35" class="mr-2 fill-current" version="1.1" id="Layer_1"
		...
		c0.51-0.91,0.79-1.95,1.26-3.13C95.53,104.38,63.01,104.38,29.75,104.38z" />
                  ...
                  <!--Fast-->
                  <svg width="35" height="35" class="mr-2" viewBox="0 0 143 100" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <p class="text-white self-center text-xl">20+</p>
                </div>
              </div>
